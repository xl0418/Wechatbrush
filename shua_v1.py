...
executable_path = {'executable_path':"E:\Wechatbrush\chromedriver_win32\chromedriver.exe"}
...
browser = Browser('chrome', **executable_path)  #Browser('chrome', options=chrome_options) #user_agent can monitor any device
